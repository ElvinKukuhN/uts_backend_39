...
class User39Controller extends Controller
{
    ...
    public function getUserDetail39(Request $request, $id)
    {
    ...
    public function putUserDetail39(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhoto39(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhotoKTP39(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPassword39(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserAgama39(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'id_agama' => 'required|exists:agama39,id',
        ]);
